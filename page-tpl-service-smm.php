<?php 
/*
Template Name: Услуга (SMM)
Template Post Type: page
*/
?>

<?php get_header(); ?>
<div class="pink-bg_seo pink-bg_smm">
    ...
    <div class="content__title" itemprop="headline">
                        ...
                        <div class="service2_text"><?php the_field('service2_text'); ?>
                            ...
                            <div class="no-desk"> <div class="service2_spec"><b>Илья Земцов</b> - SMM менеджер</div></div>
                       ...
                       <div class="no-mob"> <div class="service2_spec"><b>Илья Земцов</b><br>SMM менеджер</div></div></div>
